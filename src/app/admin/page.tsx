            ...
            <div className="text-left">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-3 bg-warm-950 border border-warm-800 rounded-xl focus:outline-none focus:border-rose-500 font-mono text-white tracking-widest transition-all"
                  autoFocus
                />
                <button
                  type="button"
